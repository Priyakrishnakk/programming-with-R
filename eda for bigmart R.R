...
bm.train<-read.csv("C:/Users/Ashok/Downloads/bigmart_train.csv",header=T,na.strings=c(""," ","NA"))
bm.test<-read.csv("C:/Users/Ashok/Downloads/bigmart_test.csv",header=T,na.strings=c(""," ","NA"))
...
fix(bm.train)   #fix is used to change or edit data
str(bm.train)   # it shows structure of data
summary(bm.train)
#############univariate analysis#######################
#Item_Identifier
...
bm.train$Outlet_Identifier<-as.factor(bm.train$Outlet_Identifier)
bm.train$Outlet_Location_Type<-as.factor(bm.train$Outlet_Location_Type)
bm.train$Item_Visibility<-as.numeric(bm.train$Item_Visibility)
bm.train$Outlet_Type<-as.factor(bm.train$Outlet_Type)
